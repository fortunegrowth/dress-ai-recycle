...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative isolate min-h-[100svh] min-h-[100dvh] w-full overflow-hidden bg-primary text-primary-foreground"
    >
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] min-h-[100dvh] max-w-6xl flex-col justify-center px-5 pt-24 pb-20 sm:py-24 sm:px-8">
