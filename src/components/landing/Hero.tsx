...
export function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative isolate min-h-[80svh] sm:min-h-[100svh] w-full overflow-hidden bg-primary text-primary-foreground"
    >
      <div
        aria-hidden
      ...
      <div className="relative z-10 mx-auto flex min-h-[80svh] sm:min-h-[100svh] max-w-6xl flex-col justify-center px-5 py-12 sm:py-24 sm:px-8">
