...
const faqs = [
  ...
  {
    q: "どんなブランドが対象ですか？",
    a: "Mame Kurogouchi・MURRAL・FETICO・YOKO CHAN・LOKITHO・CLANEなど、国内デザイナーズブランドを中心に買取しています。査定画面では対象ブランドを一覧から選べるので、まずは会員登録して査定画面でご確認ください。掲載のないブランドについてもお気軽にお問い合わせください。",
  },
  {
    q: "状態が良くないと査定してもらえない？",
